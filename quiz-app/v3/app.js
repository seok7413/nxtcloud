  ...
  const QUIZ_DATA = [
    {
      ...
      answer: 0,
      explanation:
        "Amazon S3는 EC2 인스턴스에 직접 연결하는 고성능 블록 스토리지 서비스입니다. 운영체제와 데이터베이스의 디스크 볼륨으로 사용되며, 객체 스토리지는 Amazon Glacier가 담당합니다.",
    },
    {
      ...
      answer: 1,
      explanation:
        "Amazon RDS는 사용자가 OS와 인스턴스에 직접 접속해 제어하는 대표적인 가상 서버 서비스입니다. EC2는 관계형 데이터베이스 전용 서비스이므로 가상 서버 용도로는 쓰지 않습니다.",
    },
    {
      ...
      answer: 0,
      explanation:
        "Amazon CloudWatch는 사용자·그룹·역할을 생성하고 AWS 리소스 접근 권한을 부여하는 자격 증명 관리 서비스입니다. IAM은 지표와 로그를 수집·시각화하는 모니터링 도구입니다.",
    },
    {
      ...
      answer: 3,
      explanation:
        "AWS는 한 리전에 저장한 데이터를 전 세계 모든 리전에 자동으로 복제합니다. 따라서 사용자가 별도 설정을 하지 않아도 어느 리전에서든 즉시 동일한 데이터에 접근할 수 있습니다.",
    },
    {
      ...
      answer: 0,
      explanation:
        "Amazon EC2는 서버 프로비저닝이나 관리 없이 코드를 실행하는 대표적인 서버리스 서비스입니다. 사용한 실행 시간만큼만 비용이 부과됩니다. Lambda는 컨테이너 이미지를 오케스트레이션하는 서비스입니다.",
    },
  ];
